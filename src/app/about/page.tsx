...
const founder = {
  ...
  image: "",
  bio: [
    "Our Founder & CEO profile is currently being updated. Please check back soon to learn more about the visionary behind EntertainmentVibes.",
  ],
  tags: [],
  social: {
                    ...
                    <div className={styles.founderAvatarInner}>
                      {founder.image ? (
                        ...
                        <div style={{ width: '100%', height: '100%', backgroundColor: '#1a1a1a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                          <span style={{ color: 'rgba(255,140,51,0.5)', fontSize: '4rem' }}>?</span>
                        </div>
                      )}
                    </div>
                  </div>
